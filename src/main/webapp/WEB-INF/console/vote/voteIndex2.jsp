...
<script>
function load(){
	$("#autopicture").append("<div class='swiper-slide' ><img src='${root}/upload/AAA.jpg' /></div><div class='swiper-slide' ><img src='${root}/upload/BBB.jpg' /></div><div class='swiper-slide' ><img src='${root}/upload/CCC.jpg' /></div><div class='swiper-slide' ><img src='${root}/upload/DDD.jpg' /></div>");
