...
//           //设置通用的请求属性
    ...
    public static void main(String[] args) {
		...
		jsonObject.put("interfaceId","ZCZX01");
		jsonObject.put("userName","test1" );
		jsonObject.put("createTime",new Date().getTime());
       /*interfaceUtil("https://ystzapi.light-umbrella.com/gezi-wx-api/wxapi/user/urcrSumOrSub", "{\"data\":\"OTCIkFSq192cVhBFPjA3q8In5jqXoc63RHSZNIsSbDEYukhOUwrwFgyd8TbW4cIq50TmdR9Vmgsu+SN0fcakJwwrHHiCWSplrnBBzvUo5NuhlL+bQI8k7W3wjyifb7tE\"}");*/
       interfaceUtil("https://xx.light-umbrella.com/InterfaceManage/InterfaceLibrary/addInterFaceRecordEvent",JSON.toJSONString(jsonObject));
