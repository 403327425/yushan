 ...
 * Generated at: 2019-09-06 04:17:21 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <legend>资料列表</legend>\r\n");
      out.write("</fieldset>\r\n");
      out.write("  \r\n");
      out.write("  \r\n");
      out.write("    <div class=\"layui-form\" lay-filter=\"layuiadmin-form-activity\" id=\"layuiadmin-form-activity\" style=\"padding: 20px 0 0 0;\">\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t<div class=\"layui-form-item\" >\r\n");
      out.write("\t\t\t\t<label class=\"layui-form-label\"><span class=\"layui-badge-dot\"></span>&nbsp;类别</label>\r\n");
      ...
      out.write("\t\t\t<!-- <div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t<label class=\"layui-form-label\"><span class=\"layui-badge-dot\"></span>&nbsp;名称</label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t<select id=\"candidateId\" name=\"candidateId\" class=\"layui-input\" lay-filter=\"test02\" lay-search=\"\">\r\n");
      out.write("\t\t\t\t\t<option value=\"-1\" >请选择</option>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t            </select>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div> -->\r\n");
      out.write("\t\t\t<div class=\"layui-collapse\" id=\"showbox3\" lay-filter=\"test03\" ></div>\r\n");
      ...
      out.write("\t  element.on('collapse(test03)', function(data){\r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t  });\r\n");
      ...
      out.write("\t\t    url :\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${root}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/vote/getSDList\", \r\n");
      out.write("\t\t    type : \"post\", \r\n");
      out.write("\t\t    dataType : \"json\", \r\n");
      out.write("\t\t    success : function(data)\r\n");
      out.write("\t\t    {\t\r\n");
      out.write("\t\t    \t$(\"#activityId\")\r\n");
      out.write("\t\t    \tvar str=\"<option value='-1'>请选择</option>\";\r\n");
      out.write("\t\t\t\tfor(var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tvar flag=true;\r\n");
      out.write("\t\t\t\t\tfor(var j=0;j<i;j++){\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tif(data[j].sdType==data[i].sdType){\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\tif(flag){\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tstr +=\"<option value=\"+data[i].sdType+\">\"+data[i].sdType+\"</option>\";\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("/* \t\t\t\t    \t \t  var str=\"<option value='-1'>请选择</option>\"\r\n");
      out.write("\t\t\t\t\t\t\t  for(var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\t\t  if(dtParentId==data[i].sdType){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  str+=\"<option value=\"+data[i].id+\">\"+data[i].sdName+\"</option>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t  }\r\n");
      out.write("\t\t\t\t\t\t\t  }\r\n");
      out.write("\t\t\t\t\t\t\t  $(\"#candidateId\").html(str);\r\n");
      out.write("\t\t\t\t\t\t\t  form.render(); */\r\n");
      out.write("\t\t\t\t\t\t\t  var str=\"\";\r\n");
      out.write("\t\t\t\t\t\t\t  for(var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\t\t  if(dtParentId==data[i].sdType){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  var strs1 = new Array();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  var strs2 = new Array();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  strs1 = data[i].sdHyperlinks.split(\"链接：\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  strs2 = strs1[1].split(\"提取码：\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t  str+=\"  <div class='layui-colla-item'><h2 class='layui-colla-title'>\"+data[i].sdName+\"</h2><div class='layui-colla-content '>链接：<br/><a href='\"+strs2[0]+\"'>\"+strs2[0]+\"</a>提取码：\"+strs2[1]+\"</div></div>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t  }\r\n");
      out.write("\t\t\t\t\t\t\t  }\r\n");
      out.write("\t\t\t\t\t\t\t  $(\"#showbox3\").html(str);\r\n");
      ...
      out.write("\t\t\t\t    {\t\r\n");
      out.write("\t\t\t\t    \tfor(var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\t  if(dtParentId==data[i].id){\r\n");
      out.write("\t\t\t\t\t\t\t\t  $(\"#showbox\").attr(\"style\",\"display:block;\");\r\n");
      out.write("\t\t\t\t\t\t\t\t  $(\"#showbox\").empty();\r\n");
      out.write("\t\t\t\t            \t  $(\"#showbox\").append(\"<img src='");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${root}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/upload/\"+data[i].qrCode+\"' />\");\r\n");
      out.write("\t\t\t\t\t\t\t  }\r\n");
      out.write("\t\t\t\t\t\t  }\r\n");
      out.write("\t\t\t\t    }, \r\n");
      out.write("\t\t\t\t    error: function (XMLHttpRequest, textStatus, errorThrown)\r\n");
