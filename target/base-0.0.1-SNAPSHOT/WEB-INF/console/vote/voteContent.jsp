			    		...
			    		console.log(data);
					 	   ...
					 	   for(var i=0;i<data.length;i++){
					 		   if(data[i].candidateId=="${param.candidateId}"){
					 			  ...
					 			  str+="<li><div class='padd'><a href='${root}/vote/voteContentWeb?candidateId="+data[i].candidateId+"&activityId="+data[i].activityId+"' class='img'><div class='bh bg-gray'>"+data[i].selectId+"</div><img src='${root}/upload/"+A+"' /></a><div class='tp_dd c-fff'><div class='name c-black'>"+data[i].candidateName+"</div><div class='num c-black' id='count"+data[i].candidateId+"'>人气值："+data[i].iphone+"票</div><div class='btn c-fff' onclick='msgOver()'>投票</div></div></div></li>";
